...
def isoscore(subg1, subg2):
    ...
    # return nx.graph_edit_distance(nx_graph,nx_graph1)
...
def map_score(file1, ind1, file2, ind2):
    ...
    if len(subgraphs[0]) > len(subgraphs[1]):
        ...
        r = 0
        c = 1
    print(sub_sim(subgraphs[r][0], subgraphs[c][0]))
...
if __name__ == "__main__":
    map_score("./00469642.json", 1, "./00469649.json", 0)
